...
fetch(`https://newsapi.org/v2/top-headlines?source=${source}&category=health&apiKey=${"9bfab854aba545be845be5d2c4c5acfb"}`)
  ...
  .then((json) => {
    ...
    article.forEach((element) => {
      ...
      let newsHtml = `
            <div class="card mb-3 margin" style="margin-bottom: 20px">
...
newsContainer2.innerHTML += newsHtml;
    });
    console.log(article);
  });
