...
fetch(`https://newsapi.org/v2/top-headlines?source=${source}&category=sports&apiKey=${'9bfab854aba545be845be5d2c4c5acfb'}`)
...
.then(json => {
    ...
    let newsContainer4 = document.querySelector('.newsContainer4')
...
newsContainer4.innerHTML += newsHtml
});
console.log(article)
})
